...
def train(loader, model, criterion, opt, writer, step, epoch, mixup = True, device = torch.device('cuda')):
    ...
    for idx, (lol, target) in enumerate(loop):
        ...
        train_psnr.append(batch_psnr(gen, target, 1.0))
        loss.backward()
        opt.step()
...
def validate(loader, model, criterion, writer, step, epoch, device = torch.device('cuda')):
    ...
    for idx, (lol, target) in enumerate(loop):
        ...
        val_psnr.append(batch_psnr(gen, target, 1.0))
        step += 1 
...
def main():
    ...
    TRAIN_DATA_IP = 'D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\LOLdataset\our485\low' #'/content/Data/Loldataset/our485/low'
    TRAIN_DATA_TARGET = 'D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\LOLdataset\our485\high'#'/content/Data/Loldataset/our485/high'
    VALID_DATA_IP = 'D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\LOLdataset\eval15\low'#'/content/Data/Loldataset/eval15/low'
    VALID_DATA_TARGET = 'D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\LOLdataset\eval15\high'#'/content/Data/Loldataset/eval15/high'
    SAVE_DIR = 'D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\MIRNet\Enhance'#'/content/drive/MyDrive/MIRNet/Enhance'
    LOG_DIR ='D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\MIRNet\Enhance'#'/content/drive/MyDrive/MIRNet/Enhance'
    FIXED_IP_PATH = 'D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\LOLdataset\our485\low\Fixed_IP_100.png'#'/content/Data/Loldataset/our485/low/100.png'
    FIXED_IP_TARGET = 'D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\LOLdataset\our485\high\FIXED_IP_100.png'#'/content/Data/Loldataset/our485/high/100.png'
    FIXED_IP1_PATH = 'D:\My pro-files\My files\Low-Light-Enhancement-main\Low-Light-Enhancement-main\LOLdataset\eval15\low\FIXED_IP1_111.png'#'/content/Data/Loldataset/eval15/low/111.png'
